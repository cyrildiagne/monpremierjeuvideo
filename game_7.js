...
function auto_creation() {
  ...
  ajoute_fond("assets/exemple/fond.jpg");

  // on ajoute l'image du joueur
  player = ajoute_image("assets/exemple/cat.png");
...
function auto_boucle() {
  ...
  if (une_chance_sur(100)) {
    var obstacle = ajoute_obstacle("assets/exemple/skully.png");
  ...
  if (collision) {
    ...
    // on affiche le score en grand
    affiche_score_grand(score);
  }

  // on augmente le score
  score = score + vitesse_defilement;
